        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <p class="d-inline-block" style="margin-left: 20px">
              <a href="inserir.php" class="btn btn-primary">Adicionar Liga</a>
            </p>
                      ...
                      foreach ($arrCampos as $kCampos => $vCampos) {
                        if (isset ($vCampos['listagem']) && $vCampos['listagem']) {
                          ...
                          if ($vCampos['tipo'] == 'file') {
                            $valorCampo = "<img src='$arrConfig[url_site]/uploads/$v[$kCampos]' style='max-width: 50px; max-height: 50px; height: auto; width: auto;'>";
                          }
