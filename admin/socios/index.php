            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <form method="GET" action="">
                  <div class="row p-3">
                    <div class="col">
                      <input type="text" name="codSocio" class="form-control" placeholder="Nº de Sócio"
                        value="<?php echo $filterCodSocio; ?>">
                    </div>
                    <div class="col">
                      <input type="date" name="dataInscricao" class="form-control" placeholder="Data de Inscrição"
                        value="<?php echo $filterDataInscricao; ?>">
                    </div>
                    <div class="col">
