            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      <th class='text-uppercase text-secondary text-xxs font-weight-bolder opacity-7'>Nº de Sócio</th>
                      <?php
                      foreach ($arrCampos as $kCampos => $vCampos) {
                  ...
                  <tbody>
                    ...
                    FROM $modulo
                    INNER JOIN socios ON $modulo.codSocio1 = socios.codSocio";
                    $arrResultados = my_query($query);

                    foreach ($arrResultados as $v) {
                      echo "<tr>";
                      echo "<td class='align-middle text-center text-sm'>" . $v['socioId'] . "</td>";
