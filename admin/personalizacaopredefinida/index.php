      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><?php echo $nome_modulo; ?></li>
          </ol>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <p class="d-inline-block" style="margin-left: 20px">
                    <a href="inserir.php" class="btn btn-primary">Adicionar Equipamento Predef.</a>
                </p>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center justify-content-center mb-0">
                            ...
                            <tbody>
                                <?php
                                      $query = "SELECT $modulo.*, socio.nome AS nomesocio, clube.nome AS nomeClube, socio.epoca AS epoca
                                      FROM $modulo
                                      INNER JOIN socio ON personalizacaopredefinida.socio_id = socio.id
                                      INNER JOIN clube ON socio.id_clube = clube.id";                                
                                        ...
                                        if(isset($vCampos['listagem']) && $vCampos['listagem']) {
                                            ...
                                            if ($kCampos == 'ativo') {
                                              $valorCampo = $v[$kCampos] == 1 
                                                  ? "<i class='fa fa-check-circle text-success'></i>" // Ícone de verificado para valor 1
                                                  : "<i class='fa fa-times-circle text-danger'></i>"; // Ícone de X para valor 0
                                                  // Se o campo tem 'carrega_opcoes', buscar o valor correspondente
                                            } else if(isset($vCampos['carrega_opcoes'])) {
                                                ...
                                                if($kCampos == 'socio_id' && isset($v['nomeClube']) && isset($v['nomesocio'])) {
                                                  // Aqui você ajusta para exibir "Nome do Clube - Nome do socio"
                                                  $valorCampo = $v['nomeClube'] . ' - ' . $v['nomesocio'] . ' ' . $v['epoca'];
                                                }
