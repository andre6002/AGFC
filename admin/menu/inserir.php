...
<div class="card-body"
            ...
            </a>                  <form action="trata_inserir.php" method="post" enctype='multipart/form-data' style="width: 100%; display: flex; justify-content: center; align-items: center;">
                    <table width="70%">
                      <?php
...
function mostraCamposInserir($campo, $arrInfo) {
  ...
  switch($arrInfo['tipo']) {
    ...
    case 'file':
                ...
                <div class='mb-3'><input type='file' class='form-control' name='$campo'></div></td>";
                break;
