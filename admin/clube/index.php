        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0  ">
              <h6>
                <?php echo $nome_modulo; ?>s
              </h6>
            </div>
            <p class="d-inline-block" style="margin-left: 20px">
              <a href="inserir.php" class="btn btn-primary">Adicionar Clube</a>
            </p>
                    ...
                    foreach ($arrResultados as $v) {
                      ...
                      foreach ($arrCampos as $kCampos => $vCampos) {
                        if (isset ($vCampos['listagem']) && $vCampos['listagem']) {
                          ...
                          } else if ($kCampos == 'badges_permitidos') {
                            $valorCampo = '<div class="d-flex justify-content-center gap-1">';
                            $badges = my_query("SELECT * FROM badge INNER JOIN clube_badge ON badge.id = clube_badge.badge_id WHERE clube_id = $v[id]");
                            foreach ($badges as $badge) {
                              $valorCampo .= '<img src="' . $arrConfig['url_site'] . '/uploads/' . $badge['logo'] . '" style="max-width: 50px; max-height: 50px; height: auto; width: auto;">';
                            }
                            $valorCampo .= '</div>';
                          } else {
