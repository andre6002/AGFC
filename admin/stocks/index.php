        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <p class="d-inline-block" style="margin-left: 20px">
              <a href="inserir.php" class="btn btn-primary">Atualizar Stock</a>
            </p>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT stocks.*, socio.nome AS nomesocio, clube.nome AS nomeClube, socio.epoca AS epoca
                                FROM stocks
                      ...
                      foreach ($arrCampos as $kCampos => $vCampos) {
                        if (isset ($vCampos['listagem']) && $vCampos['listagem']) {
                          ...
                          if (isset ($vCampos['carrega_opcoes'])) {
                            ...
                            if ($kCampos == 'id' && isset ($v['nomeClube']) && isset ($v['nomesocio'])) {
