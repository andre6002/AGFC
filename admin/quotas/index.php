        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <p class="d-inline-block" style="margin-left: 20px">
              <a href="inserir.php" class="btn btn-primary">Nova Quota</a>
            </p>
                    ...
                    foreach ($arrResultados as $v) {
                      ...
                      foreach ($arrCampos as $kCampos => $vCampos) {
                        if (isset($vCampos['listagem']) && $vCampos['listagem']) {
                          ...
                          } else if ($vCampos['tipo'] == 'float') {
                            $valorCampo = $valorCampo . '€';
                          } else if ($kCampos == 'quota') {
                            $valorCampo = $valorCampo . '/mês';
                          }
                          if ($kCampos == 'quota' && $v[$kCampos] == 0) {
                            $valorCampo = 'Não paga';
                          }
